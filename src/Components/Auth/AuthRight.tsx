...
const AuthRight = () => {
    ...
    return (
        <div className={`flex w-full max-w-[400px] duration-300 md:max-w-full md:w-1/2 flex-col justify-center items-center p-4 gap-4`}>
            <div className={`bg-white flex flex-col duration-300 rounded-xl w-full border`}>
